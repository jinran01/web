                        ...
                        <div class="good-item">
                            ...
                            <div class="good-desc">
                                <div class="good-title">
                                    <span id="title">{{item.goods.title}}</span>
                                    <br>
                                    <span id="description">{{item.goods.description}}</span>
                                    <br>

                                    <span id="stock">x{{item.goods.stock}}</span>
                                </div>
                                <div class="good-btn">
    ...
    setup() {
        ...
        const total = computed(()=>{
            ...
            state.list.filter(item => state.result.includes(item.id))
                ...
                .forEach(item =>{sum += parseInt(item.num) * parseFloat(item.goods.price);
                })
